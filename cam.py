...
if __name__ == '__main__':
    ...
    cv2.imwrite(f'{args.method}/cam_{args.model}.jpg', cam_image)
    cv2.imwrite(f'{args.method}/gb_{args.model}.jpg', gb)
    cv2.imwrite(f'{args.method}/cam_gb_{args.model}.jpg', cam_gb)
